...
local fileVector = {"buffer_0_25_km_agrupamentos_indigenas_BR_censo_2022_plus_POP_AMZL_new.shp", "amzl_coverage_2018_polyconic.tif", "amzl_coverage_2023_polyconic.tif"}
